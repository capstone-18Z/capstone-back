...
public interface MemberRepository extends JpaRepository<Member, String> {
    ...
    /*@Query("SELECT mk.value AS member_keyword, tk.value AS team_keyword " +
            ...
            "WHERE mk.category = tk.category and mk.field = tk.field and mk.sub = mk.sub")
    List<Object[]> findMemberKeywordsWithTeamKeywords();*/
    @Query("SELECT  tk.team.teamId,mk.member.id FROM MemberKeyword mk JOIN TeamKeyword tk ON mk.category = tk.category and mk.field = tk.field and mk.sub = mk.sub")
